...
class MainWindow : public QMainWindow {
 ...
 public:
  explicit MainWindow(QWidget *parent = 0,
                      std::shared_ptr<XiAPIWrapper> xiAPIWrapper = nullptr);
 ...
 private slots:
   ...
   */
  void UpdateComponentEditedStyle(QLineEdit *lineEdit, const QString &newString,
 ...
 private:
   ...
   */
  void InitializeImageFileRecorder(std::string subFolder = "",
   ...
   * @return
   */
  QString GetFullFilenameStandardFormat(std::string &&filePrefix,
   ...
   */
  std::shared_ptr<XiAPIWrapper> m_xiAPIWrapper =
      std::make_shared<XiAPIWrapper>();
