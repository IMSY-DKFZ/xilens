...
class XiSpecFamily : public CameraFamily {
 ...
 public:
   ...
   */
  explicit XiSpecFamily(HANDLE* handle)
      : CameraFamily(handle), m_cameraHandle(handle) {}
...
class XiCFamily : public CameraFamily {
 ...
 public:
   ...
   * @param handle camera handle used for all interactions with it
   */
  explicit XiCFamily(HANDLE* handle)
      : CameraFamily(handle), m_cameraHandle(handle) {}
...
class XiQFamily : public CameraFamily {
 ...
 public:
   ...
   * @param handle camera handle used for all interactions with it
   */
  explicit XiQFamily(HANDLE* handle)
      : CameraFamily(handle), m_cameraHandle(handle) {}
...
class Camera {
 ...
 public:
  ...
  Camera(std::unique_ptr<CameraFamily>* family, HANDLE* handle)
      : family(family), m_cameraHandle(handle) {}
