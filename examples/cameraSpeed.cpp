...
int main(int argc, char *argv[])
{
    ...
    stat = xiSetParamInt(xiH, XI_PRM_ACQ_TIMING_MODE, XI_ACQ_TIMING_MODE_FRAME_RATE);
    HandleResult(stat, "xiSetParamInt:XI_PRM_ACQ_TIMING_MODE");
    stat = xiGetParamInt(xiH, XI_PRM_FRAMERATE XI_PRM_INFO_MAX, &current_max_framerate);
    ...
    stat = xiSetParamInt(xiH, XI_PRM_FRAMERATE, std::min(80, current_max_framerate));
